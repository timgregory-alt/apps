      ...
      <header className="border-b border-[var(--color-line)] bg-[var(--color-charcoal)] px-6 py-4 text-[var(--color-ivory)]">
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          ...
          <nav className="flex items-center gap-5 text-sm">
            ...
            <Link href="/admin/dogs" className="hover:text-[var(--color-gold)]">
              Dogs
            </Link>
            <Link href="/admin/rewards" className="hover:text-[var(--color-gold)]">
              Rewards
            </Link>
            <Link href="/admin/members" className="hover:text-[var(--color-gold)]">
              Members
            </Link>
